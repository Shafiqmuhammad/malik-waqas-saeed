...
export default function TrainingShowcase({ darkMode }: TrainingProps) {
  const [filter, setFilter] = useState("All");
  const [selectedItem, setSelectedItem] = useState<any>(null);

  const filters = ["All", "Programs", "Courses", "Products", "Events", "Workshops"];
  ...
  const trainingItems = [
    {
      ...
      title: "Entrepreneur Accelerator Program",
      description: "A 6-week startup growth and funding bootcamp.",
    ...
    },
    {
      ...
      description: "Learn how to integrate AI tools into business decision-making.",
      instructor: "Muhammad Shafiq",
      price: "$99",
      location: "Hybrid (Lahore + Online)",
    },
    {
      id: 3,
      category: "Products",
      ...
      description: "Includes templates for pitch decks, marketing, and growth funnels.",
      instructor: "Altertec AI Team",
      price: "$49",
    ...
    },
    {
      id: 4,
      category: "Events",
      image: "https://images.pexels.com/photos/3184408/pexels-photo-3184408.jpeg?auto=compress&cs=tinysrgb&w=800",
      title: "Innovation Summit 2025",
      description: "Annual gathering for founders, investors, and innovators.",
    ...
    },
    {
      ...
      description: "Hands-on creative workshop for problem-solving and ideation.",
      instructor: "Waqas Saeed",
      price: "$79",
  ...
  const filteredItems =
    filter === "All" ? trainingItems : trainingItems.filter((item) => item.category === filter);
  ...
  return (
    <section className="min-h-screen py-20">
      <div className="container mx-auto px-4">
        ...
        >
          Entrepreneur &{" "}
          <span className="text-[#007F5B]">Training Programs</span>
        </motion.h2>
      ...
      {selectedItem && (
        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 text-gray-400">
              <div>
                <span className="text-[#75FFD8] font-semibold">Instructor:</span> {selectedItem.instructor}
              </div>
              <div>
                <span className="text-[#75FFD8] font-semibold">Price:</span> {selectedItem.price}
              </div>
              <div>
                <span className="text-[#75FFD8] font-semibold">Location:</span> {selectedItem.location}
              </div>
            </div>
          </motion.div>
        </motion.div>
