...
import { motion } from "framer-motion";
import { Briefcase, Presentation, Rocket } from "lucide-react";
  ...
  const services = [
    {
      ...
      description:
        "Comprehensive startup training and incubation programs that empower individuals to launch and scale their own ventures.",
      features: [
        "Business model development",
        "Funding & pitch mentorship",
    ...
    {
      icon: Presentation,
      title: "Leadership & Professional Training",
      description:
        "Interactive sessions designed to strengthen leadership, communication, and team management for corporate and startup environments.",
      features: [
    ...
    },
    {
      ...
      description:
        "Tailored workshops to help organizations and entrepreneurs integrate innovation, AI, and digital transformation into their workflows.",
      features: [
